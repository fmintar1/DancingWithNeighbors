...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dancingWithNeighborsApp.userProfile.delete.question">
        <Translate contentKey="dancingWithNeighborsApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
