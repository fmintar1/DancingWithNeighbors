...
export const FriendsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dancingWithNeighborsApp.friends.delete.question">
        <Translate contentKey="dancingWithNeighborsApp.friends.delete.question" interpolate={{ id: friendsEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-friends" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
