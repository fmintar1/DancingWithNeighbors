...
class UserProfileResourceIT {
    ...
    void createUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getStyles()).isEqualTo(DEFAULT_STYLES);
        assertThat(testUserProfile.getAvailability()).isEqualTo(DEFAULT_AVAILABILITY);
    ...
    void putExistingUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getStyles()).isEqualTo(UPDATED_STYLES);
        assertThat(testUserProfile.getAvailability()).isEqualTo(UPDATED_AVAILABILITY);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.birthdate(UPDATED_BIRTHDATE).location(UPDATED_LOCATION).availability(UPDATED_AVAILABILITY);
